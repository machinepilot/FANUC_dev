# Press Brake Electrical Diagram — Engineering Reference
**Project:** CN ESA – 420-200 TON  
...
| Auxiliary Voltage | 24 VDC / Blue — 220 VAC / Grey |
| Frequency | 50–60 Hz |
...
## 2. POWER ARCHITECTURE (Pages 1–3)

### 2.1 Main Power Feed
| Diagram ID | Component | Brand/Model | Specs | Function |
|---|---|---|---|---|
| Q1.1 | Main Switch | Lovato GA063A | 3-pole, 63A | Main disconnector |
| F1.1 | Main Fuse Holder | Lovato FB03A3P | 3-pole, Delayed, 22×58 / 50A | Main fuse protection |
| FLR1.1 | Drives Filter | Schaffner FN3270H-50-34 | 3-pole, 50A | EMI filter for Y1+Y2 drives |
| IND1.1 | Inductance – Drive Y1 | Tecnocablaggi | 32A | Line inductance for AZ8.1 |
| IND1.2 | Inductance – Drive Y2 | Tecnocablaggi | 32A | Line inductance for AZ8.2 |
| RT1.1 | Drive Y1 Switch | Lovato SM1R2500 | 3-pole, 20–25A | Motor protector for Y1 drive |
| RT1.2 | Drive Y2 Switch | Lovato SM1R2500 | 3-pole, 20–25A | Motor protector for Y2 drive |
...
- `1-1L1L2L3` → Main bus after Q1.1
- `1-2L1L2L3` → Bus to filter / transformer feeds
- `1-7L1/L2/L3` → Feed to Drive Y1 (AZ8.1)
- `1-8L1/L2/L3` → Feed to Drive Y2 (AZ8.2)

### 2.2 Transformer & Secondary Power Distribution (Page 2)
| Diagram ID | Component | Model | Primary | Secondary | Function |
|---|---|---|---|---|---|
| TR2.1 | Back Gauge Transformer | Tecnocablaggi | 380 VAC ×3 / 2A | 230 VAC ×3, 1500VA / 3.5A | Feeds back gauge servo system |
| TR2.2 | Brakes Transformer | Italweber CFM00160CC15 | 380 VAC ×2 | 230 VAC ×2 / 160VA | Powers Y-axis motor brakes |
| TR2.3 | Sheet Follower Transformer | Exom SD17S5AP24HWB | 380 VAC ×3 / 2A | 230 VAC ×3, 1500VA / 3.5A | Feeds sheet follower servo |

**Associated Fuse Holders (Lovato FB01F3P / FB01F2P — Delayed):**
| Diagram ID | Poles | Rating | Protected Circuit |
|---|---|---|---|
| F2.1 | 3 | 4A / 10.3×38 | 24 VDC Power Supply |
| F2.2 | 3 | 4A / 10.3×38 | Back Gauge Transformer |
| F2.3 | 3 | 6A / 10.3×38 | Back Gauge Power Supply |
| F2.4 | 2 | 2A / 10.3×38 | Brakes Transformer |
| F2.5 | 2 | 2A / 10.3×38 | Brakes Power Source |
| F2.6 | 3 | 4A / 10.3×38 | Sheet Follower Transformer |
| F2.7 | 3 | 6A / 10.3×38 | Sheet Follower Power Supply |

### 2.3 Crowning & Clamping Motor Power (Page 3)
| Diagram ID | Component | Brand/Model | Rating | Function |
|---|---|---|---|---|
| RT3.1 | Crowning Motor Protector | Lovato SM1P0160 | 3-pole, 1–1.6A | Protects M3.1 crowning motor |
| RT3.2 | Clamping Motor Protector | Lovato SM1P0160 | 3-pole, 1–1.6A | Protects M3.2 clamping motor |
...
| K7.1 | Crowning Contactor (+) | Lovato LOVBF09100D024 | — | Forward direction crowning |
| K7.2 | Crowning Contactor (–) | Lovato LOVBF09100D024 | — | Reverse direction crowning |
| K7.3 | Clamping Contactor | Lovato LOVBF09100D024 | — | Clamping motor contactor |
| FLR3.1 | Crowning Motor Filter | — | — | Motor RFI filter |
| FLR3.2 | Clamping Motor Filter | — | — | Motor RFI filter |

**Main Power Contactors (controlled by PCSS — Page 13):**
...
## 3. 24 VDC POWER SUPPLY ARCHITECTURE (Page 4 – 4B)

### 3.1 Primary 24 VDC Supply
| Diagram ID | Component | Brand/Model | Specs |
|---|---|---|---|
| AL4.1 | 24 VDC Power Supply | Weidmüller WD 1469550000 | In: 380VAC / 1.4A — Out: 24VDC / 20A |
| FE4.1 | Electronic Fuse Block | Weidmüller WD 1527980000 | 8-channel, 24 VDC input |

**FE4.1 Channel Map (24 VDC Outputs):**
| Channel | Max Current | Destination | Cross-ref |
|---|---|---|---|
| 4-1 | 2A | Cabinet Cooling Fans | — |
...
| K4.1 | — | Electronic Fuse Alarm relay | — |

> **⚠️ PLC/Robot Integration Note:** Channel **4-6** (6A, cross-ref 7.E0) is the 24 VDC supply powering the robot interface and clamping control circuit. Any shared I/O to/from the robot must be compatible with this 24 VDC rail.

### 3.2 Y-Axis UPS Supplies (Page 4A)
Two independent Weidmüller UPS modules provide battery-backed 24 VDC for the servo drives, maintaining safe state during power loss.

| Diagram ID | Component | Model | Specs | Powers |
|---|---|---|---|---|
| AL4.2 | UPS – Y1 Drive | Weidmüller WD 1370050010 | In: 24VDC/1.2A — Out: 24VDC/5A | AZ8.1 (Drive Y1) |
| BAT4.2 | Battery – Y1 | Weidmüller WD 1406930000 | 24 VDC / 1.3 Ah | Backup for AL4.2 |
| K4.2 | Battery Alarm – Y1 | — | NO/NC contacts | BAT4.2 fault signal |
| AL4.3 | UPS – Y2 Drive | Weidmüller WD 1370050010 | In: 24VDC/1.2A — Out: 24VDC/5A | AZ8.2 (Drive Y2) |
| BAT4.3 | Battery – Y2 | Weidmüller WD 1406930000 | 24 VDC / 1.3 Ah | Backup for AL4.3 |
| K4.3 | Battery Alarm – Y2 | — | NO/NC contacts | BAT4.3 fault signal |

### 3.3 Drive Auxiliary Supply (Page 4B)
| Diagram ID | Component | Model | Specs |
|---|---|---|---|
| DR4.1 | Diode Redundancy Module | Weidmüller WD 2486080000 | 5–48VDC 10A In / 5–48VDC 20A Out |
| FE4.2 | Electronic Fuse – Drives | Weidmüller WD 2081880000 | 4-channel, 24 VDC |
...
| 4-16 | 2A | Not Used | — |
| K4.4 | — | Electronic Fuse Alarm relay | — |

---

## 4. Y-AXIS SERVO DRIVES (Pages 8 – 8A)

The press brake uses two identical servo drive axes (Y1 left, Y2 right) for synchronized ram movement.

### 4.1 Drive Y1 — AZ8.1 AXIS Y1 (Page 8)
| Parameter | Value |
|---|---|
| Drive Model | Exom F150MR (OPDE B-110A / Tdemacno) |
| Diagram ID | AZ8.1 |
| Motor | M8.1 — Unimec MTRI 500-450-075-470-1380-750 SP UM |
| Motor Brake | BRK8.1 — Intorq BFK458-14N |
| Braking Resistance | RF8.1 — IRE HPR20010R |
| Brake Relay | K11.1 — Y1 Brake Command |
| Drive Enable Relay | K10.1 (Torque Enable) |
| Drive OK Relay | K8.2 |
| Linear Scale | Heidenhain — CN12 / ENC1 IN – PCSS (9-pin Male) |
...
| Analog – | 8-3 Brown | ESA Analog OUT PIN 9 (–) | Speed reference reference |
| DC BUS Alarm | 8X20 | → 14.C8 | DC bus fault feedback |
...
| STO Circuit – | 13Y01L | PCSS CN1 Y01L | Safe Torque Off negative |
| Thermal Pad + | 8-10 (Blue M1-85) | → K8.2 monitoring | Motor thermal protection input |
| Thermal Pad – | 8-11 (Black M1-86) | → K8.2 monitoring | Motor thermal protection return |
| Motor Phases | 1-7L1, 1-7L2, 1-7L3 | From RT1.1 | 3-phase motor power |
| Brake Command | K11.1 → 11.C5 | To brake coil | Y1 motor holding brake |

### 4.2 Drive Y2 — AZ8.2 AXIS Y2 (Page 8A)
| Parameter | Value |
|---|---|
| Drive Model | Exom F150MR (OPDE B-110A / Tdemacno) |
| Diagram ID | AZ8.2 |
| Motor | M8.2 — Unimec MTRI 500-450-075-470-1380-750 SP UM |
| Motor Brake | BRK8.2 — Intorq BFK458-14N |
| Braking Resistance | RF8.2 — IRE HPR20010R |
| Brake Relay | K11.2 — Y2 Brake Command |
| Drive Enable Relay | K8.4 |
| Linear Scale | Heidenhain — CN14 / ENC2 IN – PCSS (9-pin Male) |
...
| Analog – | 8-7 Brown | ESA Analog OUT PIN 11 (–) | Speed reference return |
| DC BUS Alarm | 8X20 | → 14.C9 | DC bus fault feedback |
...
| STO Circuit – | 13Y01L | PCSS CN1 Y01L | Safe Torque Off negative (shared Y1/Y2) |
| Thermal Pad + | 8-20 (Blue M1-87) | → K8.4 monitoring | Motor thermal protection input |
| Thermal Pad – | 8-21 (Black M1-88) | → K8.4 monitoring | Motor thermal protection return |
| Motor Phases | 1-8L1, 1-8L2, 1-8L3 | From RT1.2 | 3-phase motor power |
| Brake Command | K11.2 → 11.C6 | To brake coil | Y2 motor holding brake |

### 4.3 Linear Encoder Wiring (Pages 21–22)
Heidenhain linear scales feed position data to the PCSS for safety and to the Rack ESA for motion control.

**Pin Assignment — 9-pin Male connectors (CN12/CN14 to PCSS):**
| Pin | Signal | Wire Color |
|---|---|---|
| 1 | +5V | Blue+Green/Brown |
| 5 | –0V | White+White/Green |
| 7 | A/ | Green |
| 2 | A | Brown |
| 8 | B/ | Pink |
| 3 | B | Grey |
...
**Connections:**
- Linear Scale Y1 → CN12 (ENC1 IN – PCSS) and ENC1/ENC2 Rack ESA (CN11)
- Linear Scale Y2 → CN14 (ENC2 IN – PCSS) and ENC1/ENC2 Rack ESA (CN13)
- PCSS CN11/CN13 (ENC1/2 OUT) → Rack ESA encoder inputs via 9-pin Female
...
│                    CONTROL HIERARCHY                         │
│                                                             │
│  ESA Touch Control (HMI) ←── Ethernet/Network ──→ MOXA    │
│           │                                                 │
│      CAN Bus (CAN1)                                         │
│           │                                                 │
│      Rack ESA (CNC Controller)                              │
│      ├── I/O Rack (M.OUT1/2, M.IN1/2)                     │
│      ├── CAN1 → Back Gauge Power Supply (AL6.1)            │
│      ├── CAN1 → Sheet Follower Power Supply (AL6.2)        │
│      ├── ENC1/ENC2 (encoder pass-through to PCSS)          │
│      └── COM1 (RS232 → PCSS CN9/COM2)                     │
│                                                             │
│      PCSS Lazersafe (Safety Controller)                     │
│      ├── CN1: Y00H/Y00L (Power contactors STO)             │
│      ├── CN1: Y01H/Y01L (STO Drive Y1/Y2)                  │
│      ├── CN2: Motion outputs (LEDs, analog enable)          │
│      ├── CN3: Motion inputs (speed modes, CNC OK)           │
│      ├── CN4: Proximity & safety sensors                    │
│      ├── CN5/CN6: Safety I/O (gates, e-stops)              │
│      ├── ENC1 IN / ENC2 IN (Heidenhain encoders)           │
│      └── Photocell TX/RX (light curtain)                    │
└─────────────────────────────────────────────────────────────┘
```
...
| CAN1 – ED2PW | PCSS | Rack ESA | CANbus (9-pin Male: pins 2=CAN-L, 3=CAN-GND, 6=GND, 7=CAN-H) |
...
### 6.1 ESA M.OUT 1 — Digital Outputs (Page 9)
| ESA Output | Signal Name | Destination / Cross-ref |
|---|---|---|
| QW 1.6 | CNC OK Signal | → 15.D4 (PCSS input CN3 X07) |
| QW 1.8 | Lubrification Unit Command | K9.1 relay coil |
| QW 1.10 | Internal Lamp Command | K9.2 relay coil |
| QW 1.12 | On/Off Clamping Command | → 7A.B6 (Clamping circuit) |
| QW 1.13 | Open Clamping Alarm | → 15.D6 (PCSS input) |
| QW 1.14 | Crowning + Command | → 7.A1 (K7.1/K7.2 coil) |
| QW 1.15 | Crowning – Command | → 7.A3 (K7.3 coil) |
| QW 1.18 | (24V supply rail) | Power bus 4-2 |
| QW 1.19 | (24V supply rail) | Power bus 4-2 |

### 6.2 ESA M.OUT 2 — Digital Outputs (Page 10)
| ESA Output | Signal Name | Destination / Cross-ref |
|---|---|---|
| QW 2.0 | Slow Down Movement | → 15.D2 (PCSS) |
| QW 2.1 | Fast Down Movement | → 15.D3 (PCSS) |
| QW 2.2 | Up Movement | → 15.D3 (PCSS) |
| QW 2.3 | Decompression | → 15.D3 (PCSS) |
| QW 2.4 | Upper Dead Point | → 15.D4 (PCSS) |
| QW 2.5 | Torque Enable Command | K10.1 relay (Drive Y1/Y2 torque) → 8.D2 |
| QW 2.18 | (24V supply rail) | Power bus 4-2 |
| QW 2.19 | (24V supply rail) | Power bus 4-2 |

### 6.3 ESA M.IN 1 — Digital Inputs (Page 11)
...
| IW 0.10 | Brake Command Y1 | K11.1 → 14.C6 |
| IW 0.11 | Brake Command Y2 | K11.2 → 8A.D8 |
| IW 0.12 | Drive OK Signal | K8.2 / K8.4 → 14.C6 |
| IW 0.13 | Enable Descent | → 15.D5 |
| IW 0.14 | Slow Speed Photocell Excluded | → 15.D4 |
| IW 0.15 | Out of Grease Signal | → 5.A6 |
| IW 0.15 | Lubrification Control | → 5.A7 |
| IW 0.16 | Pedalboard 1 Up Movement (PS11.1) | → 4-3 |
| IW 0.16 | Pedalboard 2 Up Movement (PS11.2) | → 4-3 |

### 6.4 ESA M.IN 2 — Digital Inputs (Page 12)
| ESA Input | Signal Name | Source / Cross-ref |
|---|---|---|
| IW 3.0 | Enable from Y1–Y2 Brakes | M1-121 / BRK8.1/8.2 contacts |
...
| IW 3.16 | Arm in Safety for Sheet Followers | PX12.3 proximity → K12.5 |

---

## 7. PCSS LAZERSAFE I/O MAP (Pages 13–16)
...
|---|---|---|---|
| CN5 X24 | Contactors Circuit | — | 24V enable to contactor circuit |
...
| CN1 Y01H | STO + Circuit Drive Y1–Y2 | Drive AZ8.1 + AZ8.2 STO+ | Safe Torque Off positive rail |
| CN1 Y01L | STO – Circuit Drive Y1–Y2 | Drive AZ8.1 + AZ8.2 STO– | Safe Torque Off negative rail |
| K13.4 | Emergency Offset Circuit | PX13.1 / PX13.2 sensors | Triggered in emergency |

### 7.2 PCSS Outputs — CN2 (Motion Status to ESA) (Page 15)
| PCSS Connector | Signal | ESA Cross-ref | Description |
|---|---|---|---|
| CN2 Y08 | Control Light Pedalboard 2 Active | → 8A.B0 | LED indicator pedalboard 2 |
| CN2 Y07 | Control Light Pedalboard 1 Active | → 8.B0 | LED indicator pedalboard 1 |
| CN2 Y06 | Muting Red LED Command | K15.1 coil | Red muting lamp control |
| CN2 Y11 | Slow Speed Photocell Excluded | → 11.D7 (IW 0.14) | Speed mode status |
| CN2 Y09 | Down Movement Enable | → 11.D6 (IW 0.15) | Allows downward ram motion |

### 7.3 PCSS Outputs — CN1 Analog (Page 15)
| PCSS Connector | Signal | Destination | Description |
|---|---|---|---|
| CN1 Y02H | Analog Enable (+) | → AZ8.1 / AZ8.2 enable | Analog reference enable |
| CN1 Y02L | Analog Enable (–) | Return | Analog reference return |

### 7.4 PCSS Inputs — CN3 (Motion Commands from ESA) (Page 15)
| PCSS Connector | Signal | ESA Source | Description |
|---|---|---|---|
| CN3 X02 | Slow Down Movement | QW 2.0 / → 10.D2 | ESA commands slow approach |
| CN3 X03 | Fast Down Movement | QW 2.1 / → 10.D2 | ESA commands fast approach |
| CN3 X04 | Up Movement | QW 2.2 / → 10.D3 | ESA commands ram return |
| CN3 X06 | Upper Dead Point | QW 2.4 / → 10.D4 | Ram at top position |
| CN3 X05 | Decompression | QW 2.3 / → 10.D4 | Decompression phase signal |
| CN3 X07 | CNC OK Signal | QW 1.6 / → 9.D1 | CNC ready status to PCSS |
| CN3 X08 | Down Movement Enable (Foot Pedal 1 NO) | KP16.7 | Foot pedal board 1 – NO contact |
| CN3 X09 | Down Movement Enable (Foot Pedal 2 NO) | KP16.8 | Foot pedal board 2 – NO contact |
| CN3 X00 | NC Contact Down Movement (Foot Pedal 1) | KP16.7 | Foot pedal board 1 – NC contact |
| CN3 X01 | NC Contact Down Movement (Foot Pedal 2) | KP16.8 | Foot pedal board 2 – NC contact |
| CN3 X10 | NO Contact Down Movement Foot Pedalboard 2 | KP16.2 | Second pedalboard NO |

### 7.5 PCSS Inputs — CN4 (Safety & Proximity Sensors) (Page 15)
| PCSS Connector | Signal | Device | Description |
|---|---|---|---|
| CN4 X14 | Offset Circuit Contact | K12.4 (12.B4) | Back gauge offset position sensor |
| CN4 X16 | Offset Circuit Reset Selector | — | Reset back gauge offset |
...
### 7.6 PCSS Inputs — CN5 / CN6 (Gate Limit Switches & E-Stops) (Page 14)
| PCSS Connectors | Device | Model | Function |
|---|---|---|---|
| CN6 P29 / CN5 X29 | Left Gate Limit Switch | FC14.1 – Elesa CFSW.110-6-2NO+2NC | Left safety gate |
| CN6 P28 / CN5 X28 | Right Gate Limit Switch | FC14.2 – Elesa | Right safety gate |
| CN6 P27 / CN5 X27 | Rear Gate Limit Switch | FC14.4 – Elesa | Rear safety gate |
| CN6 P25 / CN6 P26 | Emergency Pushbutton Pedalboard 1 CH1/CH2 | KE14.2 – Pizzato E21PER24531 | E-stop on pedalboard 1 |
| CN5 X25 / CN5 X26 | Emergency Pushbutton Sheet Follower 2 CH1/CH2 | KE14.5 | E-stop on sheet follower 2 |
| CN5 X32 / CN6 P32 | Panic Pedal CH1 Pedalboard 1 | KP16.1 – Lovato KXB502 | Panic/anti-trip foot pedal 1 |
| CN5 X33 / CN6 P33 | Panic Pedal CH2 Pedalboard 1 | KP16.2 – Lovato KXB511 | Panic/anti-trip foot pedal 1 |
| CN5 X35 / CN6 P35 | Panic Pedal CH1 Pedalboard 2 | KP16.3 | Panic/anti-trip foot pedal 2 |
| CN5 X30 | Cabinet Door | S15.1 – Pizzato E21SC2DV A11AE | Control cabinet door switch |

### 7.7 PCSS Inputs — Drive Status (Page 14)
...
| K12.3 | Clamping enable relay | — | Interlock from ESA |
...
- Clamping open alarm → ESA input QW1.13 / PCSS input 15.D6
...
| K7.1 | Crowning motor contactor — positive direction |
| K7.2 | Crowning motor contactor — negative direction |
| FLR3.1 | Motor RFI filter |
| RT3.1 (Lovato SM1P0160) | Motor protector, 1–1.6A |
| KSC3.1 (Lovato PMV10A440) | Phase sequence and voltage monitor |

**Crowning Logic:**
- ESA output QW 1.14 → Crowning + Command → K7.1 coil
- ESA output QW 1.15 → Crowning – Command → K7.3 / K7.2 coil
- RT3.1 thermal trip → ESA input IW 3.12
- Phase sequence fault (KSC3.1) → ESA input IW 3.14
...
| Emergency Pushbutton Pedalboard 1 | KE14.2 (Pizzato E21PER24531) | CH1/CH2 → CN6 P25/P26, CN5 X25/X26 |
| Emergency Pushbutton Pedalboard 2 | KE14.3 | CH1/CH2 → Pedalboard 2 wiring |
| Emergency Pushbutton Sheet Follower 2 | KE14.5 | CH1/CH2 → PCSS |
...
```
PCSS CN1 Y01H ──→ 13Y01H ──→ AZ8.1 STO+ & AZ8.2 STO+ (shared)
PCSS CN1 Y01L ──→ 13Y01L ──→ AZ8.1 STO– & AZ8.2 STO– (shared)
```
Both Y1 and Y2 drives share the same STO circuit — either drive fault or any E-stop will remove torque from both axes simultaneously.

### 10.3 Muting & Speed Modes
| Condition | PCSS Output | Result |
|---|---|---|
| Normal Operation | — | Full safety active |
| Slow Speed Muting | CN2 Y11 → IW 0.14 | Photocell excluded, slow speed only |
| Red LED Muting Active | CN2 Y06 → K15.1 | Visual warning on CN panel |
...
### Pedalboard 1 (M3) — Wire-by-Wire Map
...
### Pedalboard 2 (M3A) — Wire-by-Wire Map
| Wire # | Terminal | Signal | Component |
|---|---|---|---|
| 1 | OV4 | Common 0V | — |
| 2 | 4-5 | 24V Power | — |
...
### CN Panel Controls — Wire-by-Wire Map
| Wire # | Terminal | Signal | Component |
|---|---|---|---|
| 1 | 4-3 | 24V Control | — |
...
| 10 | OV4 | Green LED Clamping 0V | — |
| 11 | M1-1411 | Clamping Operating Light | L17.3 |
| 12 | 4-6 | Clamping Contact Light | — |
...
| M1-85/86 | Y1 Motor Thermal Pad | — |
| M1-87/88 | Y2 Motor Thermal Pad | — |
...
### Terminal Block M2 — Key Assignments
| Terminal | Description | Component |
|---|---|---|
...
|---|---|---|---|---|---|
| CNC OK / Machine Ready | ESA QW 1.6 | → 15.D4 / PCSS CN3 X07 | QW 1.6 | 24V DO | Machine is in auto, no fault |
| Ram at Upper Dead Point | ESA QW 2.4 | → 10.D4 / PCSS CN3 X06 | QW 2.4 | 24V DO | Ram fully retracted — safe to enter zone |
| Clamping Status (Open) | ESA QW 1.13 | → 15.D6 | QW 1.13 | 24V DO | Clamping open alarm / status |
| Clamping Operating Light | 4-6 / M1-1411 | M1-1411 | — | 24V DO | Clamping currently engaged |
| Drive OK | K8.2 / K8.4 | IW 0.12 / 14.C6 | IW 0.12 | 24V DI | Both Y1 + Y2 drives healthy |
| Pedalboard Active | M1-151 | L15.1 / L15.2 | — | 24V DO | Operator has pedalboard enabled |
| Out of Grease | — | M1-57 / IW 0.15 | IW 0.15 | 24V DI | Lubrification fault |
| Safety Gate Status | FC14.1/FC14.2/FC14.4 | M1-141 to M1-146 | PCSS CN5/CN6 | Safety | Gate open = interlock |
| Up Movement Active | PCSS CN2 Y09 | → IW 0.13/0.15 | IW 0.13 | 24V DO | Ram moving up |
| Down Movement Enable | PCSS CN2 Y09 | 11.D6 | — | 24V DO | PCSS allowing downward motion |
...
> **⚠️ Critical Integration Note:** The **24V DC rail labeled 4-6** (fed from FE4.1 channel 4-6, cross-ref 7.E0) is designated for "Robot and Clamping" — this is the intended integration point for robot 24V I/O signals per the original diagram design.
...
4.  Robot: "Part Loaded / Arm Clear" → PLC to gate foot pedal or send enable
...
## 14. COMPONENT MANUFACTURERS & MODELS (Pages 25–26)
...
| RT1.1–RT3.2 | LOV11SMX1211 | Lovato | Auxiliary contact block |
...
| K9.1/K9.2 | WD 7760056364 / WD 7760056315 | Weidmüller | Output relays |
| K11.1/K11.2/K15.1 | WD 7760056362 | Weidmüller | Brake command relays |
| K4.1-2-3-4/K8.2-4/K10.1/K12.1-2/K13.3 | WD 1122880000 / WD 4060120000 / WD 7760056015 | Weidmüller | Coupling relays |
| AL4.1 | WD 1469550000 | Weidmüller | 24VDC PSU 20A |
| AL4.2/AL4.3 | WD 1370050010 | Weidmüller | 24VDC UPS modules |
| BAT4.2/BAT4.3 | WD 1406930000 | Weidmüller | UPS batteries |
| FE4.1 | WD 1527980000 | Weidmüller | Electronic fuse block |
| FE4.2 | WD 2081880000 | Weidmüller | Electronic fuse block |
...
6. FE4.1 | FE4.2 | F2.1–F2.8 (Fuse Holders)
7. K7.1 | K7.2 | K7.3 | RT1.1 | RT1.2 | RT3.1 | RT3.2
8. K13.2 | K13.3 | TR2.2 | FLR5.1 | MX5.1
9. RACK ESA | PCSS
10. M1 Terminal Block | M2 | M4 (Terminal blocks — far right)

---

*End of Reference Document — Generated from 34-page BLM Group Press Brake Electrical Diagram (Commission 04-2021/PE0122)*
