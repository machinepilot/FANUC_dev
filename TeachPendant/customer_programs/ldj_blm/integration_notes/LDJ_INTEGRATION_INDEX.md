...
canonical: false
status: evolving
supersedes: FANUC_dev/LDJ/LDJ_INTEGRATION_INDEX.md
source:
  type: onsite_notes
...
**Purpose:** Master index mapping Modbus registers â†’ Kvara shared addresses â†’ PLC signals (C0â€“C11) â†’ ESA Rack I/O (QW/IW) â†’ Terminal blocks (M1/M2) for BLM press brake + FANUC robot integration.
...
**Integration path:** Phase 1 = XC2F/XC3M/XC4M hardwire (primary); foot pedal sim = alternative if robot interface connectors unavailable. Phase 2 = Modbus TCP (program load, mode â€” not beam control).

---

## Robot Interface Cross-Reference (XC2F/XC3M/XC4M â€” Primary)
...
|----------|--------|--------|-----------|----------|-------------|----------|
| Mode | 0 | PPMode | â€” | â€” | Operating mode selection | Load=Editor, Start=Auto |
| Strobe | 1 | PPCommand | â€” | â€” | Command handshake strobe | Set 1 â†’ wait ack â†’ clear |
| Program Name | 2 (80 regs) | PPProgram | â€” | â€” | Program name string | Load/Change program |
| Program Name (alt) | 53 (40 regs) | â€” | â€” | â€” | Quick_Ref: STRING | See VENDOR_DISCREPANCIES |
| Command Ack | 82 / 1231 | PPClientAckCmd | â€” | â€” | Command received/complete | Wait before next command |
| Error | 1024 | PPErrorCode | â€” | â€” | Error code (0=OK) | Check after every command |
| Foot Pedal Sim | â€” | â€” | KP16.7/16.8 | M1-167 / M1-168 | PLC DO in parallel with NO contact | Phase 1: Trigger bend cycle |
| CNC OK | â€” | â€” | QW 1.6 | 15.D4 | Machine ready | Robot: safe to approach |
| Ram UP | â€” | â€” | QW 2.4 | 10.D4 | Upper dead point | Robot: safe to load/unload |
| Clamping | â€” | â€” | QW 1.12 | 7A.B6 | Clamping command | Robot: clamp/unclamp |
| Clamping Status | â€” | â€” | QW 1.13 | 15.D6 | Clamping open alarm | Status feedback |
| Drive OK | â€” | â€” | IW 0.12 | 14.C6 | Both drives healthy | Safety interlock |
| Robot Cell Clear | â€” | â€” | ESA/PCSS input | Gate/FC14.x | Robot arm clear | Inhibit down until clear |
| Inhibit Down | â€” | â€” | QW 2.0/2.1 gate | CN3 X02/X03 | Prevent ram down | Robot in zone |
| Part Present | â€” | â€” | ESA M.IN | Spare PCSS | Part positioned | Confirm load |
| E-Stop (Robot) | â€” | â€” | PCSS CH1/CH2 | KE14.x chain | Robot fault | Dual-channel safety |
...
| Vendor discrepancies | reference/VENDOR_DISCREPANCIES.md | â€” |
| Electrical diagram | press_brake_reference.md | 34-page diagram |
| Signal flow | INTEGRATION_FLOW.md | â€” |
...
- **24V from press:** XC2F Pin 2 (24 VDC PRESS) â€” do NOT use robot-side 24V for these signals
- **Network:** Press 172.16.0.51, PLC 172.16.0.50, Port 502
- **Mode:** Editor for Load/Modify; Auto for Start
- **Handshake:** Write data â†’ Reg 2 opcode â†’ Reg 1 BIT0=1 â†’ wait Reg 1231 BIT0=1 â†’ clear strobe â†’ check Reg 1024
- **24V integration rail (foot pedal alt):** FE4.1 channel 4-6 (7.E0) â€” Robot Interface & Clamping
