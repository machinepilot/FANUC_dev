...
canonical: false
status: evolving
supersedes: FANUC_dev/LDJ/PHYSICAL_WIRING_OVERVIEW.md
source:
  type: onsite_notes
...
Connect the FANUC robot to the BLM press brake via the Wago PLC using hardwired I/O. **Phase 1A (primary):** XC2F/XC3M/XC4M robot interface connectors â€” beam-level control. **Phase 1B (alternative):** Foot pedal sim when robot interface unavailable. Modbus TCP is Phase 2 (program load, mode â€” not beam control).
...
## Robot Interface Connectors (Primary â€” Phase 1A)
...
| **0V reference** | XC2F Pin 1 (0 VDC PRESS) â€” common for all I/O |
| **Do NOT** | Use robot-side 24V for these signals â€” press powers robot I/O interface |

### XC2F â€” Press â†’ Robot (Inputs to PLC)
...
| 16â€“17 | E21.6 | Press Devices Out of Robot Area | Collision avoidance |

### XC3M â€” Robot â†’ Press (Outputs from PLC)
...
**XC3M Pins 1â€“16:** Dry contacts (safety) â€” Enable, Fence, Emergency. See robot_interface_reference.md.

---

## Foot Pedal Sim (Alternative â€” Phase 1B)
...
- **Phase 1A:** Use 24V from XC2F Pin 2 (press-supplied) for all robot interface signals. Wire gauge 0.5â€“1.0 mmÂ² (AWG 20â€“18).
- **Phase 1B:** Foot Pedal Sim â€” 24V (4-6) through PLC relay NO contact to M1-167 or M1-168.
- **Isolation:** Use relay or opto-isolator between PLC and press.
- **Wire gauge:** 0.5â€“1.0 mmÂ² (AWG 20â€“18) typical
...
| File | Purpose |
|------|---------|
| **[robot_interface_reference.md](robot_interface_reference.md)** | **Primary â€” full signal set, cycle timing, interlock rules** |
